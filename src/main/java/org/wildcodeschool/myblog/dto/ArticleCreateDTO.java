...
public class ArticleCreateDTO {
    ...
    public @NotEmpty(message = "La liste des auteurs ne doit pas être vide") List<AuthorContributionDTO> getAuthors() {
        return authors;
    }

    public void setAuthors(@NotEmpty(message = "La liste des auteurs ne doit pas être vide") List<AuthorContributionDTO> authors) {
